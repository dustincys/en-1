...
If you want to know more details about that, you could just reference the ```User Guide```at Hompage, This ```job script``` below I wrote according to the user guide of ```stampede```.
