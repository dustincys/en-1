...
There are three ways to set the environment variables on your Ubuntu. Two of them can set a peramental path and the last one just sets a temporary path. 
