...
```   
> What is the difference of the schema file between MySQL and Sqlite3   
If you want to convert the format from MySQL to Sqlite3, you should change some settings in
MySQL.   
