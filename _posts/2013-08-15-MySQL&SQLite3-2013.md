...
- Step3: Dump Out the data from MySQL (or sqlite3)
...
What is the difference of the schema file between MySQL and Sqlite3. For example, if you want to convert the format from MySQL to Sqlite3, you should change some settings in MySQL.   
